...
/**
 * Standard functions (imap_utf7_decode, imap_utf7_encode) works incorrectly with Cyrillic (Russian).
 * For example string '&BBIEMAQ2BD0EPgQ1-' convert to '06 = >5' instead 'Важное' (gmail & yandex)
 * 
 * @examples 
 *    Utf7::decode('&BBIEMAQ2BD0EPgQ1-');
 *    Utf7::encode('Важное');
 * 
 * @see http://php.net/manual/ru/function.imap-utf7-decode.php#116677
 * @see http://stackoverflow.com/questions/15807151/imap-encoding-and-decoding-utf-8-issue
 */
class Utf7 {
    static $imap_base64  = 
